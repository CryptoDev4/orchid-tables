...
class OrchidTablesServiceProvider extends ServiceProvider
{
    ...
    protected function bootForConsole(): void
    {
        ...
        $this->publishes([
            __DIR__ . '/../public/' => base_path('public/vendor/cryptodev4-orchid-tables/')
    ...
    private function registerResources(): self
    {
        View::composer('platform::app', function () {
            $this->dashboard
                ->registerResource(
                    'scripts',
                    mix('/js/bulkselect.js', 'vendor/cryptodev4-orchid-tables')
                )
                ->registerResource(
                    'stylesheets',
                    mix('/css/bulkselect.css', 'vendor/cryptodev4-orchid-tables')
                );
        });
